...
class Transaction:
    """
    Document of an exchange in currency from a sender to one or more recepients.
    """
    ...
    def update(self, sender_wallet, recipient, amount):
        """
        Update the transaction with an existing or new receipt
        """
    ...
    @staticmethod
    def is_valid_transaaction(transaction):
        """"
        This method will validate the transaction and will raise and error for invalid transactions.
        """
