...
def test_mine_block():
    # It ensures that the mine_block method doesn't break after some feature addition
...
def test_genesis():
    # It ensures that the gensis block works as expected even after feature additions
...
def test_is_valid_block_bad_block_hash(last_block, block):
    block.hash = '00000000000000000404000abc'
